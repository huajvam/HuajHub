...
local ANIM_LOGGER_FILE_CANDIDATES = {
	...
	"./scripts/AnimLogger.lua",
	"scripts/AnimLogger.lua",
	"Pottasium/scripts/AnimLogger.lua",
	"C:/Users/kevvu/Music/Pottasium/scripts/AnimLogger.lua",
	"C:\\Users\\kevvu\\Music\\Pottasium\\scripts\\AnimLogger.lua",
}
...
local function getAnimLoggerPathCandidates()
	...
	if type(listfiles) == "function" then
		for _, root in ipairs({
			...
			"./scripts",
			"scripts",
			"C:\\Users\\kevvu\\Music\\Pottasium\\scripts",
			"C:/Users/kevvu/Music/Pottasium/scripts",
		}) do
...
do
	...
	local function ensureAntiFallState(character)
...
do
	...
	local AUTO_PARRY_MAKER_FILE = "huajhub/AutoParryConfig"
